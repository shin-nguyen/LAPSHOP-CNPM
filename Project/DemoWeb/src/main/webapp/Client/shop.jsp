                                                ...
                                                <div class="product_desc">
                                                    ...
                                                    <div class="add-actions">
                                                        <ul class="add-actions-link">
                                                            <li class="add-cart active"><a href="shopping-cart.jsp">Add to cart</a></li>
                                            ...
                                            <div class="col-lg-5 col-md-7">
                                                <div class="product_desc">
                                                    <div class="product_desc_info">
                                                        ...
                                                        <h4><a class="product_name" href="single-product.jsp">Hummingbird printed t-shirt</a></h4>
                                                        <div class="price-box">
                                                            <span class="new-price">$46.80</span>
                                                        </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="shop-add-action mb-xs-30">
                                                    <ul class="add-actions-link">
                                                        ...
                                                        <li class="wishlist"><a href="wishlist.jsp"><i class="fa fa-heart-o"></i>Add to wishlist</a></li>
