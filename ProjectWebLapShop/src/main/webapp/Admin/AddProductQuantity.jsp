                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Add product quantity</strong>
                                </div>
                                <div class="card-body card-block">

                                    <form action="${pageContext.request.contextPath}/NhapHangController" method="post"  class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label"> Quantities <c:out value="${soLuongError}"/> </label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text"  name="soLuong" placeholder="Quantities" class="form-control" required>
                                            </div>
                                        </div>
